---
layout: post
title: 'java agent crack'
subtitle: '深入剖析 Java Agent 型内存马'
tags: 安全 内存马 Java
---

注：本文首发在先知社区: [Agent 内存马的攻防之道](https://xz.aliyun.com/t/13110)
...
![image-20231210215251001](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215251001.png)
...
![image-20231210215324800](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215324800.png)
...
![image-20231210215341504](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215341504.png)
...
![image-20231210215359822](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215359822.png)
...
![image-20231210215418549](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215418549.png)

## 防护模式

可看到“关键类”  `T`  的大小为  `654`：

![image-20231210215511078](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215511078.png)
...
![image-20231210215527294](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215527294.png)
...
![image-20231210215547693](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215547693.png)
...
![image-20231210215604016](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215604016.png)

当攻击者使用  `redefineClasses`  时，同样的，**由于防守方的检测 Agent 在类被重定义之后加载，所以可成功看到被攻击者重定义后的类**。

![image-20231210215617948](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215617948.png)
...
![image-20231210215631004](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215631004.png)

![image-20231210215640671](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215640671.png)
...
![image-20231210215704493](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215704493.png)
...
![image-20231210215716623](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215716623.png)

那么就很简单了，从  `libjvm.so`中可以很方便的找到这个符号的相对地址：

![image-20231210215729076](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215729076.png)
...
![image-20231210215740618](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215740618.png)
...
![image-20231210215752661](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215752661.png)

他是获取对象的地址，那我们也可以反其道而行之，创建一个对象数组，然后将  `jobject`  地址放在这个对象数组的 0 号偏移处，然后这个对象数组的 0 号元素，不就是我们心心念的对象了么：

![image-20231210215804385](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215804385.png)
...
![image-20231210215821725](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215821725.png)
...
![image-20231210215835325](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215835325.png)
...
![image-20231210215848102](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215848102.png)

查看  `/tmp/T.bb40.class`，虽然防守方检测到了  `HttpServlet`  被重新加载了，但是所看到的这个  `HttpServlet`  仍是正常的：

![image-20231210215859797](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215859797.png)

不过，内存马早已经被注入成功：

![image-20231210215910821](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215910821.png)

![image-20231210215920775](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215920775.png)

未指定  `cmd`  参数时：

![image-20231210215930203](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215930203.png)
...
![image-20231210215949585](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210215949585.png)
...
![image-20231210220002532](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220002532.png)
...
![image-20231210220026164](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220026164.png)
...
我们从哪里可以找一个  `JavaVM`  对象呢？我们可以在源码中找到这个一个对象:  [main_vm](https://github.com/openjdk/jdk8u/blob/jdk8u121-b13/hotspot/src/share/vm/prims/jni.cpp#L5031)，而其本身是静态符号，也就是说，我们可以直接从  `libjvm.so`  的符号表中找到他:

![image-20231210220048916](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220048916.png)
...
![image-20231210220058188](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220058188.png)
...
![image-20231210220134160](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220134160.png)
...
![image-20231210220144937](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220144937.png)

而这个变量存在于  `libjvm.so`  的符号表中，所以我们可以直接去内存中读取该变量的值，来决定我们需要怎样得到  `klass`  的地址。

![image-20231210220154010](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220154010.png)
...
![image-20231210220206460](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220206460.png)
...
![image-20231210220219555](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220219555.png)
...
![image-20231210220235690](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220235690.png)

jdk1.0.2 的 major\_version 为 45，jdk21 的 major\_version 为 65。而 minor_version 在jdk 1.2 之后基本上一直是 0。我们可以先假定  `_minor_version`  的位置，然后在其附近寻找符合该规则的 version 字段。从而真正确定  `_minor_version`  的位置。

确定  `_minor_version`  位置后，可以看到  `_methods`  就在他的不远处，根据  `InstanceKlass`  的结构，计算一下  `_methods`  相对于  `_minor_version`  的偏移。

![image-20231210220248198](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220248198.png)
...
![image-20231210220302565](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220302565.png)
...
![image-20231210220314146](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220314146.png)

正常的 jdk  `1.8.0_181`:

![image-20231210220345249](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220345249.png)

arm64 下的  `jdk 1.8.0_202`:

![image-20231210220359029](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220359029.png)
...
![image-20231210220424022](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220424022.png)
...
![image-20231210220438113](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220438113.png)
...
![AgentX-1](/assets/img/md/2023-12-01-java-agent-crack.assets/t.gif)
...
![image-20231210220559142](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220559142.png)
...
![image-20231210220520042](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220520042.png)

作为对比，可以试试针对之前  `NoAgent.jsp`  的检测效果：

![image-20231210220530899](/assets/img/md/2023-12-01-java-agent-crack.assets/image-20231210220530899.png)
...
不过，本文主要的目的还是提供理论依据，所提供的攻击代码仅仅是 demo，并不会保证绝对稳定。而我们了解了技术细节后，便可以做到真正的知己知彼，在攻防问题上占据更多的主动权。比如寻找一些特定的攻击方式，例如上文中提到的  `NoAgent.jsp`  这种方式注入的内存马，可以被内存马检测工具扫描到。那么我们是不是可以在修改关键类后，将自身卸载，并添加守护线程去定期检测之前的修改是否被回滚，若已被回滚，则重新在链末尾注入一次即可，这样的话，即便防御者进行内存马扫描，也无法发现我们所注入的内存马，且我们所注入的内存马并不会随着防御者的扫描而失效。类似的“微操”还可以有很多，有兴趣的可以一起讨论。
